...
export declare class PrivacySDK {
   ...
   */
  computeSalaryCommitment(salary: string, employerId: string, employeeId: string): string;
   ...
   */
  computeVoteCommitment(proposalId: number, vote: boolean, salt: string): string;
   ...
   * @param employeeId - Employee account ID
   */
  computeDeductionCommitment(deductionType: string, amount: string, employeeId: string): string;
   ...
   */
  computeAmountCommitment(amount: string, employeeId: string, bonusType: string): string;
}
